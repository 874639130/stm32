...
void RTC_TimeAndDate_Set(void)
{
	...
	RTC_TimeStructure.RTC_Hours =rtcdata.RTC_Hours; //HOURS;        
	RTC_TimeStructure.RTC_Minutes =rtcdata.RTC_Minutes;// MINUTES;      
	RTC_TimeStructure.RTC_Seconds =rtcdata.RTC_Seconds; //SECONDS;      
	RTC_SetTime(RTC_Format_BINorBCD, &RTC_TimeStructure);
	//RTC_WriteBackupRegister(RTC_BKP_DRX, RTC_BKP_DATA);
	
  // 初始化日期	
	RTC_DateStructure.RTC_WeekDay = WEEKDAY;       
	RTC_DateStructure.RTC_Date = rtcdata.RTC_Date;//DATE;         
	RTC_DateStructure.RTC_Month = rtcdata.RTC_Month;//MONTH;         
	RTC_DateStructure.RTC_Year = rtcdata.RTC_Year;//YEAR;        
...
//	char LCDTemp[100];
  	...
  	if(Rtctmp != RTC_TimeStructure.RTC_Seconds)
    {
			...
			// 打印日期
      MESSAGE("The Date :  Y:20%0.2d - M:%0.2d - D:%0.2d - W:%0.2d\r\n", 
...
//			RTC_DateStructure.RTC_WeekDay);
			...
			rtcdata.RTC_Year=RTC_DateStructure.RTC_Year;
			rtcdata.RTC_Month=RTC_DateStructure.RTC_Month;
			rtcdata.RTC_Date=RTC_DateStructure.RTC_Date;
			//LCD_DisplayStringLineEx(10,50,48,48,(uint8_t *)LCDTemp,0); 
			
			// 打印时间
      MESSAGE("The Time :  %0.2d:%0.2d:%0.2d \r\n\r\n", 
...
//			RTC_TimeStructure.RTC_Seconds);
      ...
      rtcdata.RTC_Hours=RTC_TimeStructure.RTC_Hours;
			rtcdata.RTC_Minutes=RTC_TimeStructure.RTC_Minutes;
			rtcdata.RTC_Seconds=RTC_TimeStructure.RTC_Seconds;
